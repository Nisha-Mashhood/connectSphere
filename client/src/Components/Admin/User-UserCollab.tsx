...
const UserUserCollab = () => {
  ...
  const getStatusBadge = (requestStatus: string, connectionStatus: string) => {
    if (requestStatus === "Pending") return "bg-yellow-100 text-yellow-800";
    if (requestStatus === "Accepted" && connectionStatus === "Connected")
      return "bg-green-100 text-green-800";
    if (requestStatus === "Accepted" && connectionStatus === "Disconnected")
      return "bg-red-100 text-red-800";
    if (requestStatus === "Rejected") return "bg-red-100 text-red-800";
    return "bg-gray-100 text-gray-800";
  };

  const getBadgeLabel = (requestStatus: string, connectionStatus: string) => {
    if (requestStatus === "Accepted" && connectionStatus === "Disconnected")
      return "Disconnected";
