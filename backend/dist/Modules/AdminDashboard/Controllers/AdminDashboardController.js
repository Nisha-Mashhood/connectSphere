...
class AdminController {
    getTotalUsersCount = async (_req, res) => {
        try {
    ...
    getTotalMentorsCount = async (_req, res) => {
        try {
    ...
    getTotalRevenue = async (_req, res) => {
        try {
    ...
    getPendingMentorRequestsCount = async (_req, res) => {
        try {
    ...
    getActiveCollaborationsCount = async (_req, res) => {
        try {
    ...
    getPendingMentorRequests = async (req, res) => {
        try {
    ...
    getRecentCollaborations = async (req, res) => {
        try {
            const { limit } = req.query;
