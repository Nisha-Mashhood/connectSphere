...
export const makeStripePaymentController = async (req, res) => {
    ...
    try {
        ...
        const paymentIntent = "paymentIntent" in paymentResult
...
export const markUnavailableDays = async (req, res) => {
    const { collabId } = req.params;
...
// Update Time Slots
export const updateTemporarySlotChanges = async (req, res) => {
    const { collabId } = req.params;
...
export const approveTimeSlotRequest = async (req, res) => {
    const { collabId } = req.params;
    ...
    try {
        ...
        const updatedCollaboration = await processTimeSlotRequest(collabId, requestId, isApproved, requestType);
        res.status(200).json({
